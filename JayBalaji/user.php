                   			...
                   			<table  id="user_data" class="table table-bordered table-striped display nowrap data" >
                   				<thead>
									<tr>
										...
										<th scope="col" data-orderable="false">Delete</th>
									</tr>
								</thead>
                   			</table>
                   		</div>
        			...
        			<div class="modal-body">
        				<div class="form-group">
							...
							<input type="text" name="user_name" id="user_name" class="form-control" required = "required" 
                                   required pattern="[a-zA-Z0-9]{3,}" title="Name must be alphanumeric and contain atleast 3 characters"/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="password" name="user_password" id="user_password" class="form-control" required = "required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
						</div>
        			</div>
...
<script>
//$('table tr').find('td:eq(),th:eq(1)').remove();
